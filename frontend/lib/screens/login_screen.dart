...
import 'package:frontend/screens/registro_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> iniciarSesion() async {
    ...
    if (respuesta['success'] == true) {
      ...
      //TODO Descomentar cuando se implemente HomeScreen
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextButton(
              onPressed: () {
	              //TODO Descomentar cuando se implemente Registro Screen
